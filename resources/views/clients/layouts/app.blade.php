        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="index.html">
                    <span class="align-middle">{{ Auth::user()->company_name }}</span>
                </a>
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item @if(Route::currentRouteName() == 'login') active @endif">
                        <a class="sidebar-link" href="{{ route('checkList.index') }}">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                ...
                                <img src="{{ url('images/default-driver.png') }}" class="avatar img-fluid rounded me-1"
                                    alt="Charles Hall" /> <span class="text-dark">{{ Auth::user()->company_name }}</span>
                            </a>
